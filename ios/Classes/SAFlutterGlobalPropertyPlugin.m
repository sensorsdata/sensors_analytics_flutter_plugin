//
// SAFlutterGlobalPropertyPlugin.m
...
@interface SAFlutterGlobalPropertyPlugin()
@property (nonatomic, copy) NSDictionary<NSString *, id> *globleProperties;
@end

@implementation SAFlutterGlobalPropertyPlugin

- (instancetype)initWithGlobleProperties:(NSDictionary *)properties {
    self = [super init];
    if (self) {
